"""
Script pour créer automatiquement la table WEB_GMAO_REPARATION
et migrer les données depuis WEB_GMAO
"""
from db import get_db_cursor
import sys

def setup_web_gmao_reparation():
        ...
        with get_db_cursor() as cursor:
            ...
            if result and result.table_exists > 0:
                ...
                if response.lower() == 'o':
                    ...
                    print("✅ Utilisation de la table existante.")
                    return True
...
if __name__ == "__main__":
    ...
    print("Création de la table WEB_GMAO_REPARATION")
    print("=" * 60)
    success = setup_web_gmao_reparation()
    print("=" * 60)
    if success:

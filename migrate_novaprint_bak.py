...
def migrate_novaprint_backup():
    ...
    print("Fichier: Base NOVAPRINT du 03102025")
    print("Emplacement: C:\\Users\\pack2\\OneDrive\\Documents")
    print()
    
    # Chemin du fichier .BAK
    bak_file_path = r"C:\Users\pack2\OneDrive\Documents\Base NOVAPRINT du 03102025.bak"
...
if __name__ == "__main__":
    ...
    print("Fichier de sauvegarde: Base NOVAPRINT du 03102025.bak")
    print("Emplacement: C:\\Users\\pack2\\OneDrive\\Documents")
    ...
    print("- Restaurer le fichier .BAK vers novaprint_restored")
